            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                ...
                <div className="mb-20">
                    <div className="flex items-center gap-3 mb-8">
                        ...
                        <h2 className="text-3xl md:text-4xl font-bold text-gray-900">Journal Publications</h2>
                    </div>
                    ...
                    <div className="grid gap-4">
                        {journals.map((journal) => (
                            <div key={journal.id} className="bg-white border border-gray-200 p-6 rounded-xl flex flex-col md:flex-row md:items-center gap-4 group hover:border-[#ffd700] transition-all shadow-sm hover:shadow-lg">
                                ...
                                {journal.sjr && (
                                    <div className="flex-shrink-0">
                                        <span className={`px-4 py-1.5 rounded-full text-sm font-bold ${journal.sjr === 'Q1' ? 'bg-[#ffd700] text-gray-900' : 'bg-gray-100 text-gray-700'}`}>
                                            SJR: {journal.sjr}
                                        </span>
                                    </div>
                                )}
                ...
                <div>
                    <div className="flex items-center gap-3 mb-8">
                        <span className="text-[#ffd700] text-2xl">★</span>
                        <h2 className="text-3xl md:text-4xl font-bold text-gray-900">Publications Ethics</h2>
                    </div>

                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {ethics.map((item) => (
                            <div key={item.id} className="bg-[#f8f6f2] border border-gray-200 rounded-xl p-6 hover:bg-[#ffd700]/5 hover:border-[#ffd700] transition-colors">
