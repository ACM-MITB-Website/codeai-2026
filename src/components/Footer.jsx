...
function Footer() {
    return (
        <footer className="bg-[#1a2332] text-white border-t-4 border-[#ffd700]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex flex-col gap-2 text-sm">
                                <a href="/file/CODE-AI 2025 Brochure.pdf" className="flex items-center gap-2 text-gray-300 hover:text-[#ffd700] transition-colors" download>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex gap-4">
                            <a href="mailto:codeai.mitblr@manipal.edu" className="w-12 h-12 bg-white/10 border border-white/20 rounded-full flex items-center justify-center text-gray-300 hover:bg-[#ffd700] hover:text-gray-900 hover:border-[#ffd700] transition-all">
