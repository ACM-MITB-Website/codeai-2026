        ...
        <main className="pt-24 pb-16 bg-gradient-soft min-h-screen">
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="glass-card rounded-2xl p-8 mb-8">
                    <h2 className="text-2xl font-semibold text-gray-800 mb-4">Submission Types</h2>
                ...
                <div className="glass-card rounded-2xl p-8 mb-8">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                        {importantDates.map((item, idx) => (
                            <div key={idx} className="bg-gradient-to-br from-blue-500 to-purple-600 rounded-xl p-4 text-white text-center">
                                <p className="text-2xl font-bold">{item.date.split(' ')[0]}</p>
                                <p className="text-sm opacity-90">{item.date.split(' ').slice(1).join(' ')}</p>
                ...
                {/* Themes */}
                <div className="glass-card rounded-2xl p-8 mb-8">
                    <h2 className="text-2xl font-semibold text-gray-800 mb-6">Themes for CODE-AI 2026</h2>
                ...
                <div className="glass-card rounded-2xl p-8 text-center">
                    <h2 className="text-2xl font-semibold text-gray-800 mb-4">Paper Format</h2>
